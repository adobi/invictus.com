        ...
        <fieldset class="control-group">
            ...
            <div class="controls">
                <?php if ($item && $item->image): ?>
                    ...
                    <a href="<?php echo base_url() ?>platform/delete_image/<?php echo $item->id ?>" class="pull-right" style="margin-right:20px;" data-ajax-link="1" rel="tooltip" title="Delete image"><i class="icon-trash"></i></a>
                <?php else: ?>
