  ...
  <legend>
    &nbsp;
      <p class="pull-right">
        ...
        <?php if ($the_item): ?>
          <a href="<?php echo base_url() ?>gameplatform/delete/<?php echo $the_item->id ?>" class="btn delete-item" data-location="r" rel="tooltip" title="Delete platform" data-modal-header="Game platform"><i class="icon-trash"></i></a>
        <?php endif ?>
      </p> 
  </legend>
