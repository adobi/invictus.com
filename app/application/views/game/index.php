              ...
              <div class="caption " style="">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" style="left:100px;">
                    <li>
                      <a data-action="<?php echo $item->is_active ? 'inactivate' : 'activate' ?>" href="<?php echo base_url() ?>game/action/<?php echo $item->is_active ? 'inactivate' : 'activate' ?>/<?php echo $item->id ?>" class="_btn action" rel="tooltip" title="<?php echo $item->is_active ? 'Inactivate' : 'Activate' ?> game"><i class="icon-lock"></i><?php echo $item->is_active ? 'Inactivate' : 'Activate' ?></a>
                    </li>
                    <li class="divider"></li>
                    <li>
