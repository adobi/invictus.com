        ...
        <div class="item">
            <h4>
              ...
              <p class="pull-right" style="margin-top:5px;">
                ...
                <a href="<?php echo base_url() ?>contact/delete/<?php echo $item->id ?>" class="btn delete-item" data-location="l" rel="tooltip" title="Delete contact"><i class="icon-trash"></i></a>
              </p>
            </h4> 
            <h6>
              <?php echo $item->email ?> &nbsp; &nbsp; &nbsp;
        ...
        <div class="item" id = "<?php echo $item->id ?>">
            <h4>
              ...
              <p class="pull-right" style="margin-top:5px;">
                ...
                <a href="<?php echo base_url() ?>contacttype/delete/<?php echo $item->id ?>" class="btn delete-item" data-location="l" rel="tooltip" title="Delete email"><i class="icon-trash"></i></a>
              </p>
            </h4> 
            <p>&nbsp;</p>
        </div>
