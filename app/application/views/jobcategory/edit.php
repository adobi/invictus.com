        ...
        <fieldset class="control-group">
            ...
            <div class="controls">
                <?php if ($item && $item->icon): ?>
                    ...
                    <a href="<?php echo base_url() ?>jobcategory/delete_image/<?php echo $item->id ?>" class="btn delete-image pull-right" style="margin-right:20px;" rel="tooltip" title="Delete icon"><i class="icon-trash"></i></a>
                <?php else: ?>
