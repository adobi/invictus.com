        ...
        <?php endforeach ?>
         -->          
          <li class="span2 selected-game">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/flyfu/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/roc/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/froggyjump/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/lazyfarmer/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/greedcorp/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/mistbouncer/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/santaride/Icon170.png">
              </a>
            </div>
          </li>
          <li class="span2">
            <div class="thumbnail game">
              <a href="#">
                <img alt="" src="assets/games/froggylauncher/Icon170.png">
              </a>
            </div>
          </li>      </ul>
    </div>
    <div class="span4 details-pane" style="height:auto;">
      <div class="details-pane-logo-big">
        ...
        <img alt="" src="http://placehold.it/370x260" style="">
         -->
         <img src="assets/games/lazyfarmer/hero-small.png" alt="">
      </div>
